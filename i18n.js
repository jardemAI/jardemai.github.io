...
const translations = {
  "en": {
    ...
    "hero.riskValue": "High",
    "animation.signal1Label": "Signal",
    "animation.signal1Value": "mixed-language request",
    "animation.signal2Label": "Local check",
    "animation.signal2Value": "trusted source routing",
  ...
  "ru": {
    ...
    "animation.signal1Label": "Сигнал",
    "animation.signal1Value": "смешанный языковой запрос",
    "animation.signal2Label": "Локальная проверка",
    "animation.signal2Value": "маршрутизация к источнику",
  ...
  "kk": {
    ...
    "animation.signal1Label": "Сигнал",
    "animation.signal1Value": "аралас тілдегі сұрау",
    "animation.signal2Label": "Локал тексеріс",
    "animation.signal2Value": "сенімді дереккөзге бағыттау",
